...
<p align="center">
  <img src="screenshots/architecture_3d.png" width="850" alt="NeuralStream 3D Architecture">
</p>

## 📌 The Engineering Narrative
**The Challenge:** In a production streaming environment like Netflix or Spotify, the catalog contains millions of titles. A standard "ranking" algorithm is mathematically too slow to score every single item for every user in real-time. This is the **Scale-vs-Latency Paradox**.
...
*   **Sub-50ms Inference Latency:** Leveraged **FAISS (Facebook AI Similarity Search)** to perform Approximate Nearest Neighbor (ANN) search, reducing retrieval complexity from $O(N)$ to $O(\log N)$.
...
The system retrieves the top-K candidates from the vector space by calculating the **Inner Product** between the live User "Passport" (embedding) and pre-computed Item "DNA."
...
Before engineering the system, I conducted a deep-dive EDA in the **Research Lab** (`notebooks/research_lab.ipynb`) to understand interaction density and item popularity bias.

<p align="center">
  <img src="screenshots/eda_insights.png" width="750" alt="EDA Insights">
</p>
...
*   **Model Performance:** The architecture achieved convergence by Epoch 2, proving the efficiency of the learned embeddings in capturing user preferences.

<p align="center">
  <img src="screenshots/loss_curve.png" width="600" alt="Loss Curve">
</p>

---

## ⚔️ Engineering "Warrior Stories"
*Real-world engineering is about navigating hurdles. Here is how I resolved critical bottlenecks during this build:*
...
**Problem:** Raw dot-product scores are mathematically accurate but unintuitive for business stakeholders and analysts.  
**Resolution:** Implemented a **Frontend Normalization Layer** using Min-Max scaling to translate raw latent-space distances into user-friendly "Match Confidence" percentages relative to the candidate pool.
...
`cd Two-Tower-Neural-Retrieval-and-Ranking-System`
